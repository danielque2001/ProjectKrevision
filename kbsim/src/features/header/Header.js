...
import {
  BsMoonFill as Moon,
  BsFillBrightnessAltHighFill as Sun,
} from 'react-icons/bs';
    ...
    >
      <div className={styles.headerContainer}>
        <div className={styles.backhome}>
          <a href="https://www.projectkecommerce.store/index.php">Back to Home Page</a>
        </div>
        <div className={styles.subnav} onClick={toggle}>
          {currentTheme === 'light' ? (
            <Moon className={styles.lightswitch} />
          ) : (
            <Sun className={styles.lightswitch} />
          )}
        </div>
      </div>
